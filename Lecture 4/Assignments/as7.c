...
int main() {
    ...
    printf("Road Network:\n");
    printf("     %c   %c  [%c] [%c]  %c   %c   %c   %c\n",  charging_stations[0], charging_stations[1], CHARGING_STATION_C, CHARGING_STATION_D, charging_stations[4], charging_stations[5], charging_stations[6], charging_stations[7]);
